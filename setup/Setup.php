    ...
    public static function setup(Event $event) {
        ...
        switch ($config['spIsPublicAdministration']) {
            ...
            case false: 
                if (!isset($config['spOrganizationCodeType']) 
                    ...
                    if($_organizationCodeTypeChoice==1) {
                        $config['spOrganizationIdentifier'] = "VATIT-" . ltrim($_fpaIdCodice, "IT");
                    } else {
                        $config['spOrganizationIdentifier'] = "CF:IT-" . $_fpaIdCodice;
                    }
                }
        ...
        */
        ...
        if (file_exists($config['installDir'] . "/cert/spid-sp.crt") && file_exists($config['installDir'] . "/cert/spid-sp.pem")) {
            ...
            shell_exec(
                    "openssl11 req -new -x509 -config spid-php-openssl.cnf -days 730 " .
